 ...
 */
export function getClientSubscriptionsV1Search(
  client: SafepayCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetClientSubscriptionsV1SearchRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/client/subscriptions/v1/search")();
  ...
  const context = {
    ...
    operationID: "get_/client/subscriptions/v1/search",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.GetClientSubscriptionsV1SearchResponse$inboundSchema,
