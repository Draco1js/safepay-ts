 ...
 * Search Plans
 */
export function getClientPlansV1Search(
  client: SafepayCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetClientPlansV1SearchRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/client/plans/v1/search")();
  ...
  const context = {
    ...
    operationID: "get_/client/plans/v1/search",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetClientPlansV1SearchResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
