 ...
 * Search Transactions
 */
export function getClientTransactionsV1Search(
  client: SafepayCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetClientTransactionsV1SearchRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/client/transactions/v1/search")();
  ...
  const context = {
    ...
    operationID: "get_/client/transactions/v1/search",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.GetClientTransactionsV1SearchResponse$inboundSchema,
