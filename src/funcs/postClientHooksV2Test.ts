 ...
 * Test Webhook
 */
export function postClientHooksV2Test(
  client: SafepayCore,
...
> {
  ...
  const context = {
    ...
    operationID: "post_/client/hooks/v2/test",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PostClientHooksV2TestResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr(400, errors.PostClientHooksV2TestBadRequestError$inboundSchema, {
      hdrs: true,
    }),
    M.jsonErr(
      401,
