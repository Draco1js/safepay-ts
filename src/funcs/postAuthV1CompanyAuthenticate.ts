 ...
 * Create Merchant JWT
 */
export function postAuthV1CompanyAuthenticate(
  client: SafepayCore,
...
> {
  ...
  const context = {
    ...
    operationID: "post_/auth/v1/company/authenticate",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.PostAuthV1CompanyAuthenticateResponse$inboundSchema,
