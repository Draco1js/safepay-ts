 ...
 * Search Quick Links
 */
export function getInvoiceQuickLinksV1(
  client: SafepayCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetInvoiceQuickLinksV1Request$outboundSchema.optional().parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "get_/invoice/quick-links/v1",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetInvoiceQuickLinksV1Response$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr(
