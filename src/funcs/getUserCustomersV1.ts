 ...
 * List Customers
 */
export function getUserCustomersV1(
  client: SafepayCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetUserCustomersV1Request$outboundSchema.optional().parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "get_/user/customers/v1",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetUserCustomersV1Response$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
